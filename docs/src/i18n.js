  ...
  <other-agent>/...`,
    ...
    claude: {
      ...
      bundles: {
        ...
        items: [
          { title: 'my-bundle@0.1.0 (remote)', body: 'Universal starter fetched straight from the AI-Kit repository (source: "remote"). Adapts to any stack via inputs and ships the ai-kit ops skill — manage the installation in natural language.' },
  ...
  <другой-агент>/...`,
    ...
    claude: {
      ...
      bundles: {
        ...
        title: 'С чего начать',
        items: [
          { title: 'my-bundle@0.1.0 (remote)', body: 'Универсальный стартер прямо из репозитория AI-Kit (source: "remote"). Подстраивается под любой стек через inputs и включает ops-скилл ai-kit — управление установкой на естественном языке.' },
