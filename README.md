...
| Preset                | What you get                                                                                              |
|-----------------------|-----------------------------------------------------------------------------------------------------------|
| `my-bundle@0.4.1` | Universal constructor served from `bundles/my-bundle/0.4.1` (`source: "remote"`). Targets **Claude Code and Codex**. CLAUDE.md/AGENTS.md are assembled from per-technology toggles (`technologies`: kmp, android, coroutines, compose, decompose, ktor, tests) plus a manifest-backed project profile that survives regeneration. Includes guidance for keeping documentation aligned with public behavior. Ships `/remember` and `/generate` for maintaining the project profile. |
